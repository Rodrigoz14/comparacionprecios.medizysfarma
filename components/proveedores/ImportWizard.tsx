      ...
      <section className="space-y-4 rounded-lg border border-zinc-200 bg-white p-4 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
        ...
        <div>
          ...
          <input
            ...
            className="mt-1 w-full text-sm text-zinc-500 file:mr-3 file:cursor-pointer file:rounded file:border-0 file:bg-brand-green file:px-3 file:py-1.5 file:text-xs file:font-medium file:text-white file:transition-colors hover:file:opacity-90"
          />
        </div>
